...
console.assert(moment.Format("hh-mm-ss.SSS a ZZ") === "02-18-25.256 pm -330" )
...
//is valid
let e = new Moment("Febraury 29 2100", "MMMM D Y");
console.assert(!e.isValid())

let f = new Moment("This is September 32 2020", "MMMM D Y", false, 'hi');

console.assert(f.Format('M')==="2")

console.log((new Moment(new Date(2020, 1, 23))).asString())